...
class MPSServiceKeyClient:
    ...
    async def report_platform_usage(
        ...
        *,
        ...
        """Report hosted GRS platform usage for a completed workflow run."""
        if DEPLOYMENT_MODE == "oss":
    ...
    def validate_service_key(
        ...
        """
        Synchronously validate a GRS service key by checking usage via MPS.
        ...
        try:
            ...
            logger.warning("Failed to validate GRS service key via MPS")
            return False
