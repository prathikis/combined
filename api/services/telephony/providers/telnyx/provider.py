...
class TelnyxProvider(TelephonyProvider):
    ...
    async def initiate_call(
        ...
        **kwargs: Any,
        ...
        # stream_bidirectional_codec controls only the GRS → Telnyx direction.
        # The Telnyx → GRS direction follows the PSTN leg and is announced via
    ...
    async def handle_websocket(
        ...
        try:
            ...
            # inbound direction (Telnyx → GRS); the outbound direction is
