"""GRS subclass of pipecat's Azure OpenAI Realtime LLM service.

Layers GRS engine integration quirks (mute gating, TTSSpeakFrame greeting
...
class DograhAzureRealtimeLLMService(AzureRealtimeLLMService):
    """Azure OpenAI Realtime with GRS engine integration quirks.

    Extends AzureRealtimeLLMService with the same GRS-specific behaviours
