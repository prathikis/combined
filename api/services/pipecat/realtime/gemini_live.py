"""GRS subclass of pipecat's Gemini Live LLM service.
...
class DograhGeminiLiveLLMService(GeminiLiveLLMService):
    """Gemini Live with GRS engine integration quirks. See module docstring."""
    ...
    # ------------------------------------------------------------------
    # Context lifecycle: GRS pre-populates self._context via the engine,
    ...
    # init-instruction reconciliation (GRS updates system_instruction at
    ...
    # kick off bot turns in the GRS flow.
    # ------------------------------------------------------------------
