"""GRS subclass of pipecat's Gemini Live Vertex AI LLM service.

Diamond inheritance: combines the GRS engine-integration overrides from
...
class DograhGeminiLiveVertexLLMService(
    ...
    """Vertex AI variant of Gemini Live with GRS integration quirks."""

    pass


# Guard against MRO regressions: a future refactor that flips inheritance
# order or breaks the diamond would silently bypass the GRS overrides.
