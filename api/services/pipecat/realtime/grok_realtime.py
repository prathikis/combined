"""GRS subclass of pipecat's Grok Realtime LLM service.
...
- **finalized=True on TranscriptionFrame** for parity with GRS's other
  realtime providers.
"""
...
class DograhGrokRealtimeLLMService(GrokRealtimeLLMService):
    """Grok Realtime with GRS engine integration quirks."""
