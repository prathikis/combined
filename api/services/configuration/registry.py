...
DOGRAH_PROVIDER_MODEL_CONFIG = provider_model_config("GRS")
...
class DograhLLMService(BaseLLMConfiguration):
    ...
    model: str = Field(
        default="default",
        description="GRS-hosted model tier.",
...
class GoogleTTSConfiguration(BaseTTSConfiguration):
    ...
    model: str = Field(
        default="chirp_3_hd",
        description=(
            "Google Cloud low-latency TTS engine. GRS maps this to Pipecat's "
...
class DograhEmbeddingsConfiguration(BaseEmbeddingsConfiguration):
    ...
    model: str = Field(
        default="default",
        description="GRS-managed embedding model.",
