...
Usage:
    ...
    python -m evals.stt.benchmark audio/multi_speaker.m4a --diarize --keyterms "GRS" "Pipecat"
"""
...
Examples:
  python -m evals.stt.benchmark audio/multi_speaker.m4a --diarize
  python -m evals.stt.benchmark audio/multi_speaker.m4a --diarize --providers deepgram
  python -m evals.stt.benchmark audio/multi_speaker.m4a --keyterms "GRS" "API"
        """,
    )
    parser.add_argument(
        "audio_file",
