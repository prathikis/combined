...
<p align="center">
  <img src="docs/images/hero.gif" alt="GRS 实战演示 —— 搭建工作流、启动语音智能体、直接对话" width="80%">
</p>
...
<div align="center">
  <a href="https://www.youtube.com/watch?v=xD9JEvfCH9k">
    <img src="https://img.youtube.com/vi/xD9JEvfCH9k/maxresdefault.jpg" alt="Better Stack 介绍 GRS" width="80%" style="border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
  </a>
  <br>
  <em><strong>Better Stack</strong> 上手实测 —— 深入体验 GRS</em>
</div>
...
<div align="center">
  <a href="https://youtu.be/9gPneyf9M9w">
    <img src="docs/images/video_thumbnail_1.png" alt="观看 GRS AI 演示视频" width="70%" style="border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
  </a>
</div>
...
| **自带 LLM / STT / TTS** | ✅ 任意厂商,也可使用 GRS 自带方案 | 在其集成范围内可配置 | 在其集成范围内可配置 |
...
> **⚡ 想让 AI 智能体帮你完成部署?**
> 如果你使用 **Claude Code** 或 **Codex**,可以安装官方的 [GRS 部署技能(skill)](https://github.com/dograh-hq/dograh-plugins),让智能体替你完成安装、配置与排障——它会识别你的操作系统、选择合适的部署方式、运行 GRS 自带的部署脚本并验证结果。
>
> ```text
> # 在 Claude Code 中
...
> ```
>
> 然后开启一个新会话,让它 _"set up GRS"_(或运行 `/dograh-setup`)。Codex 同样支持——详见[插件仓库](https://github.com/dograh-hq/dograh-plugins#install)。
...
> 🔑 **无需 API Key。** GRS 自带一套自动生成的密钥,以及内置的 LLM / TTS / STT 栈。你可以随时接入自己的 LLM、TTS、STT 或电信服务商(如 Twilio、Vonage、Telnyx)。
...
- **Slack** —— GRS AI 协作的主阵地。在这里和维护者交流、在动手前讨论功能、获取部署帮助,并跟进每一轮贡献活动。
- **GitHub Discussions** —— 分享使用场景、提问、交流工作流配方。
- **GitHub Issues** —— 报告 bug 或提交功能请求。

👉 加入我们 → [GRS 社区 Slack](https://join.slack.com/t/dograh-community/shared_invite/zt-3zjb5vwvl-j7hRz3_F1SOn5cH~jm5f5g)

## 🙌 参与贡献

我们欢迎一切贡献!GRS AI 100% 开源,也会一直保持下去。
...
<a href="https://star-history.com/#dograh-hq/dograh&Date">
  <img src="https://api.star-history.com/svg?repos=dograh-hq/dograh&type=Date" alt="GRS 的 Star 历史" width="80%">
</a>

## 📄 许可协议

GRS AI 基于 [BSD 2-Clause 协议](LICENSE)开源 —— 与构建 GRS AI 时所采用的项目使用相同的协议,确保兼容性,以及自由使用、修改和分发的权利。

## 🏢 关于我们

由 **GRS**(Zansat Technologies Private Limited)用 ❤️ 打造。
