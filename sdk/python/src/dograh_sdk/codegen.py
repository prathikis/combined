...
GRS backend. Source of truth: the backend's model-backed node-spec
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(
        ...
        description="Generate typed SDK dataclasses from the GRS node-spec catalog.",
    )
    source = parser.add_mutually_exclusive_group(required=True)
    source.add_argument("--api", help="GRS backend base URL")
