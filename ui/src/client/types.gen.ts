...
export type GoogleTtsConfiguration = {
     ...
     * Model
     *
     * Google Cloud low-latency TTS engine. GRS maps this to Pipecat's streaming Google TTS service for Chirp 3 HD and Journey voices.
     */
    model?: string;
    /**
     * Voice
...
export type HttpApiConfig = {
     ...
     * Preset Parameters
     *
     * Parameters injected by GRS from fixed values or workflow context templates.
     */
