---
title: "Introduction"
description: "Build and operate GRS voice AI agents programmatically from Python or TypeScript"
---

GRS ships official SDKs for **Python** and **TypeScript** that wrap the GRS REST API and the workflow builder. Use them to create or edit agents, place outbound calls, and inspect runs from your own code.
