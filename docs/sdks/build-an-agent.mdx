...
description: "Assemble a GRS voice agent programmatically with the SDK and save it as a draft"
---
...
- A GRS [API key](/configurations/api-keys) exported as `DOGRAH_API_KEY`
- An existing agent ID to save drafts against (create one in the GRS UI or via [`POST /api/v1/workflow/create`](/api-reference/agents/create-from-template))
