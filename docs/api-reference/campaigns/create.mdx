...
The `time_slots` field controls when GRS is allowed to place calls. If omitted, calls can be placed at any time. The `timezone` field applies to all time slot windows.
