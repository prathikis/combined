...
| Field | Description |
| --- | --- |
| **Endpoint URL** | The URL GRS will send the POST request to. |
...
GRS sends a `POST` request with the following JSON payload:
