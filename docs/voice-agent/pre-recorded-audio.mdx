...
## Step 2: Configure the cloned voice in GRS

1. Go to your agent's **Model Configuration** in the GRS dashboard.
...
Navigate to the **Recordings** page in the GRS dashboard. Recordings are shared across all agents in your organization. You can either upload pre-recorded audio files or record directly in the browser.
