...
GRS platform ships with Deepgram, Cartesia, OpenAI and GRS transcribers by default. You can take a look at the providers documentation of which language to select for your language requirements. 
