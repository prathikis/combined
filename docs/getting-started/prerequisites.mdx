---
title: "Prerequisites"
description: "System requirements and setup needed to run GRS AI locally"
---
...
To run GRS AI locally, make sure you have the following installed:
...
GRS images are available from two registries:
