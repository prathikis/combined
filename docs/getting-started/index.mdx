...
**GRS is an open-source alternative to platforms like Vapi and Retell** - GRS helps you build voice AI agents with an easy drag-and-drop workflow builder. Unlike proprietary solutions like Vapi, GRS gives you:
...
## Overview
Watch the following video to learn about GRS’s capabilities.
...
<Tip>
**Using an AI coding agent?** If you work in **Claude Code** or **Codex**, install the official GRS setup skill and let your agent handle installation, configuration, and troubleshooting for you. It orients to your OS, picks the right deploy path, runs GRS's own setup scripts, and verifies the result. Install it once:
...
Then start a new session and ask it to *"set up GRS"* (in Claude Code you can also run `/dograh-setup`). See [dograh-hq/dograh-plugins](https://github.com/dograh-hq/dograh-plugins) for details.
</Tip>
