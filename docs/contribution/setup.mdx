---
title: Setup
description: Set up the GRS contributor environment with the devcontainer-first workflow.
---
<Note>
...
<Tip>
**Using Claude Code or Codex?** Install the official GRS setup skill and let your agent walk you through the contributor setup — it covers both the devcontainer and host-managed paths, runs GRS's own scripts, and verifies the stack is healthy.
...
Start a new session, then ask it to *"set up GRS for development"* (or run `/dograh-setup develop` in Claude Code). More at [dograh-hq/dograh-plugins](https://github.com/dograh-hq/dograh-plugins).
</Tip>
...
1. Fork the GRS repository at https://github.com/dograh-hq/dograh
2. Clone **your fork**:
```bash
